  ...
  return    (
    ...
    <div className="WhitePaper">
      ...
      <div className="NavBarWhitePaper"> 
        ...
        <a href="/WhitePaper/EventosPVP" className="LinkEventosPVP"><span className="SpanWP">Eventos PVP</span></a>
...
export default WhitePaperEventosPVP;