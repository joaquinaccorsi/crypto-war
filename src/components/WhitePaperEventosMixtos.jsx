...
function WhitePaperEventosMixtos (){
  return    (
    ...
    <div className="WhitePaper">
      ...
      <div className="NavBarWhitePaper"> 
        ...
        <a href="/WhitePaper/EventosMixtos" className="LinkEventosMixtos"><span className="SpanWP">Eventos Mixtos</span></a>
...
export default WhitePaperEventosMixtos;